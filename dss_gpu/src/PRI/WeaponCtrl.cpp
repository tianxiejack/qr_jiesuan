...
/*
	ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ°å·¢ï¿½ÍµÄ¿ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
	ï¿½ï¿½ï¿½ï¿½Ý¸ï¿½ï¿½ï¿½È·ï¿½ï¿½ï¿½ï¿½Æ½Ì¨ï¿½ï¿½Öµï¿½ï¿½ï¿½ï¿½Ì¨×ªï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ð¸ï¿½ï¿½ï¿½

	Æ½Ì¨ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ï¢ï¿½ï¿½ï¿½ï¿½:
		ï¿½ï¿½ï¿½Ù¿ï¿½Ê¼ - ï¿½ï¿½Â¼ï¿½Ç¶ï¿½ï¿½ï¿½Ï¢
...
void processCMD_TIMER_SENDFRAME2(LPARAM lParam)//ï¿½ï¿½ï¿½ï¿½Ö¡2
{
#if 0
	if(isBootUpMode()&&isBootUpSelfCheck())
		return ;

	//todo: ï¿½ï¿½ï¿½Ô¼ï¿½×´Ì¬ï¿½ï¿½ï¿½ï¿½ÊµÊ±ï¿½ï¿½ï¿½Âµï¿½×´Ì¬?ï¿½Ó¶ï¿½Ê±ï¿½ï¿½?
	(BYTE9(CANSendFrame2)) &= 0XFE;
	(BYTE9(CANSendFrame2)) |= (0XFE | bMachineGunSensorOK());//5.8ï¿½Ç¶È´ï¿½ï¿½ï¿½ï¿½ï¿½×´Ì¬
	(BYTE9(CANSendFrame2)) &= 0XFD;
	(BYTE9(CANSendFrame2)) |= (0XFD | (bGrenadeSensorOK()<<1));//35ï¿½ï¿½Ç¶È´ï¿½ï¿½ï¿½ï¿½ï¿½×´Ì¬
	(BYTE9(CANSendFrame2)) &= 0XFB;
	(BYTE9(CANSendFrame2)) |= (0XFB | (bPositionSensorOK()<<2));//Ë®Æ½ï¿½Ç¶È´ï¿½ï¿½ï¿½ï¿½ï¿½×´Ì¬
	(BYTE9(CANSendFrame2)) &= 0XF7;
	(BYTE9(CANSendFrame2)) |= (0XF7 | (bDipAngleSensorOK()<<3));//ï¿½ï¿½Ð±ï¿½Ç¶È´ï¿½ï¿½ï¿½ï¿½ï¿½×´Ì¬
	(BYTE9(CANSendFrame2)) &= 0XEF;
//	(BYTE9(CANSendFrame2)) |= ;//ï¿½ï¿½×¼ï¿½ï¿½×´Ì¬ todo value
	(BYTE9(CANSendFrame2)) &= 0XDF;
	(BYTE9(CANSendFrame2)) |= (0XDF | (bVideoOK()<<5));//ï¿½ï¿½Æµï¿½ï¿½ï¿½ï¿½×´Ì¬
...
//case Frame_Type0: //Ö¡0ï¿½ï¿½ï¿½ï¿½
	if(BYTE1(FrameBuf0)!= BYTE3(buf)){
		if(0x05==(BYTE3(buf)))   //ï¿½Å·ï¿½ï¿½ï¿½ï¿½ï¿½È¨ï¿½ï¿½ï¿½Ç·ï¿½ä»¯
		{
...
void WeaponCtrlPORT_ParseFrameByte_type1(unsigned char* buf)
{
	...
	if(BIT1_0(BYTE1(FrameBuf1)) != BIT1_0(BYTE3(buf)))	//Ñ¡
	{     
		if(BIT1_0(BYTE3(buf)) == 0x00)			//Ô¶×°
	...
	if(BIT6_4(BYTE1(FrameBuf1)) != BIT6_4(BYTE3(buf)))	//  Ð»
	{
	...
	if(BIT3_2(BYTE2(FrameBuf1)) != BIT3_2(BYTE4(buf)))  //ÆµÓ³Ð¡Ñ¡
	{     
	...
	if(BIT0(BYTE2(FrameBuf1)) != BIT0(BYTE4(buf)))  //5.8Ç¹Ê½
	{   
	...
	if(BIT4(BYTE3(FrameBuf1)) != BIT4(BYTE5(buf)))	   //à·½Ê½
	{   
