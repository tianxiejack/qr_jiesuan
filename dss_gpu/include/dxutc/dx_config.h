...
#define CFGID_TURRET_DP_Angle			CFGID_BUILD(BLKID_DATA3_SAVE, 5)
#define CFGID_MACH_DP_Angle			CFGID_BUILD(BLKID_DATA3_SAVE, 6)
#define CFGID_GRENADE_DP_Angle			CFGID_BUILD(BLKID_DATA3_SAVE, 7)
